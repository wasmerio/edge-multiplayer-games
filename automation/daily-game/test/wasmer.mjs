...
const manifest = readFileSync(`${root}/wasmer.toml`, 'utf8');
...
const env = {
  ...process.env, HOME: '/tmp', PYTHONEXECUTABLE: python, PYTHONPATH: `/app:${tests}`,
...
for (const file of ['test_bash_operations.mjs', 'test_capture.mjs', 'test_pi_events.mjs', 'test_pi_runtime.mjs']) {
